...
$query1 = "SELECT * FROM blogcategories WHERE `caturl`='$pageurl'";
$run1 = mysqli_query($conn, $query1);
$row1 = mysqli_fetch_assoc($run1);
$catid = $row1['blogs_id'];

$query2 = "SELECT * FROM blogs INNER JOIN blogcategories ON blogcategories.blogs_id = blogs.blogcategories  WHERE `shownavbar` = 'Yes' AND `blogcategories`= $catid  ORDER BY id DESC ";
                ...
                <div class="col-md-4">
                  <div class="card border-0 pb-3">
                    ...
                    <div class="img-wraper rounded">
                      <img class=" inner-img card-img-top rounded pb-2" src="admin/'. $rowforblog['img'] .'" alt="Card image" style="width:100%">
                    </div>
