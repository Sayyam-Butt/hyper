                        ...
                        <div class="card">
                           <div class="card-body">
                              <div class="form-group">
                                 ...
                                 ?>
                                       <input  onkeyup="createurl(this.value)" type="text" id="simpleinput" required class="form-control" value="<?php echo $row['name'] ?>" name="sub-category">

                              </div>
                              <div class="form-group">
                                 <label for="simpleinput">Url</label>
                                 <input required type="text" id="sluggenrated" class="form-control" value="<?php echo $row['subcaturl']?>" name="link">
                              </div>
                              <div class="form-group">
                                 <label for="metaTitle">Meta Title</label>
                                 <div class="input-group input-group-merge">
                                    <input required type="text" id="metaTitle" class="form-control" name="meta_title" value="<?php echo $row['meta_title']?>">
